<template> 
    ...
    import { DxDataGrid, DxPaging, DxSelection, DxScrolling, DxGrouping,DxGroupPanel,  DxSummary, DxNumberBox,
 ...
 //       params += 'key=446e1ad0f5a04797dc30d7abee8458ea887e051f&cities=27,95&dateStartFrom=2022-8-22&sort=date-asc&type=river&dateEndTo=2023-11-01&';
      ...
      console.log(headers);
        ...
        return fetch(`https://river.germes.rdbx.dev/api/orders${params}`, {headers})
    ...
    export default {
      components: {
        ...
        DxSummary,
        DxTotalItem,
        DxGrouping, DxGroupPanel, DxNumberBox,
